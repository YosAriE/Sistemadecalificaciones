...
<body>
    ...
    <table border="1">
        ...
        require 'db.php';
        $buscar = $_POST['buscar'];
        $sql = "SELECT id, materia, parcial1, parcial2, ordinario1, ordinario2 FROM primero WHERE materia like '$buscar' '%'";
        ...
        while ($mostrar = mysqli_fetch_row($resultado)) {
            ...
            <tr>
                ...
                <td>
                    ...
                    materia=<?php echo $mostrar[1] ?> &
                    parcial1=<?php echo $mostrar[2] ?> &
                    parcial2=<?php echo $mostrar[3] ?> &
                    ordinario1 = <?php echo $mostrar[4] ?> &
                    ordinario2 =<?php echo $mostrar[5] ?>
                    ">Editar</a>
